...
/**
 * A LegacyBlockInfoReader is responsible for building {@link org.jcontainer.loom.components.util.info.ComponentInfo}
 * objects from <a href="http://jakarta.apache.org/avalon/phoenix">Phoenixs</a> BlockInfo descriptors. The format for
 * descriptor is specified in the <a href="package-summary.html#external">package summary</a>.
 *
...
public final class LegacyBlockInfoReader extends AbstractLogEnabled implements BlockInfoReader
{
    ...
    public LegacyBlockInfoReader( final ClassLoader classLoader, final Logger logger )
    {
        if( null == classLoader )
        {
    ...
    public ComponentInfo buildComponentInfo( final Class type ) throws Exception
    {
        ...
        final InputStream inputStream = m_classLoader.getResourceAsStream( xinfo );
        ...
        else
        {
            ...
            final Configuration configuration = ConfigurationBuilder.build( input, BLOCKINFO_SCHEMA, getLogger() );
    ...
    /**
     * Create a {@link org.jcontainer.loom.components.util.info.ComponentInfo} object for specified classname from
        ...
        throws Exception
    {
        if( getLogger().isDebugEnabled() )
        {
            final String message =
                REZ.format( "legacy.builder.creating-info.notice",
                            type.getName() );
        ...
        final DependencyDescriptor[] dependencies =
            buildDependencies( type.getName(), configuration );
        ...
        final SchemaDescriptor schema = buildConfigurationSchema( type.getName(), configuration );
    ...
    /**
     * A utility method to build an array of {@link DependencyDescriptor} objects from specified configuration and
     * classname.
     *
    ...
    /**
     * A utility method to build a {@link DependencyDescriptor} object from specified configuraiton.
     *
     * @param classname  The classname of Component (used for logging purposes)
        ...
        throws ConfigurationException
    {
        ...
        else
        {
            ...
            {
                final String message =
                    REZ.format( "legacy.builder.redundent-key.notice",
                                classname,
                                key );
    ...
    /**
     * A utility method to build an array of {@link ServiceDescriptor} objects from specified configuraiton.
     *
    ...
    /**
     * A utility method to build a {@link ServiceDescriptor} object from specified configuraiton data.
     *
