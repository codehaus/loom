 ...
 * @version $Revision: 1.10 $ $Date: 2003-12-03 10:44:42 $
 */
public class ComponentMetaDataConverter
{
    ...
    /**
     * Convert a set of {@link org.jcontainer.loom.components.util.profile.ComponentProfile}
     * object into a set of BlockMetaData objects.
     *
     * @param components the {@link org.jcontainer.loom.components.util.profile.ComponentProfile}
     * objects
     * @return the BlockMetaData objects
     */
    private static BlockMetaData[] toBlocks(
    ...
    /**
     * Convert a ComponentTemplate object into a {@link BlockListenerMetaData}
     * object.
     *
     * @param listeners the ComponentTemplate object
     * @return the {@link BlockListenerMetaData} object
     */
    public static BlockListenerMetaData[] toBlockListeners(
     ...
     */
    public static BlockMetaData toBlockMetaData(
